...
import com.e_commerce_backend.userservice.Repositories.UserSessionRepository;
...
public class UserSessionService implements IUserSessionService{
    ...
    public List<UserSession> terminateAllUserSessionsForUsers(List<String> userIds){

        Optional<List<UserSession>> optionalUserSessions = userSessionRepository.getAllUserSessionsForUsers(userIds);
